...
* **1.2 Asignamos los recursos de hardware:**  
  Le damos a nuestra máquina un mínimo de **2048 MB de RAM** (2 GB) y **1 CPU** para que funcione de manera fluida.
   ...
   <p align="center">
    <img src="https://github.com/gorkamonso2004/home-lab-samba/blob/25b79904f989aee01887370d3a7e1abe681d158c/cap7.png" alt="Creación de la máquina virtual en VirtualBox" width="80%" />
  </p>
